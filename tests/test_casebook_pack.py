"""Regression checks for the packet-sys-arena-core casebook."""
...
from casebook.harness import assert_expected, packet_sys_arena_core_summary
...
class CasebookTests(unittest.TestCase):
    ...
    def test_named_summary_alias(self) -> None:
        self.assertEqual(packet_sys_arena_core_summary(), assert_expected())
