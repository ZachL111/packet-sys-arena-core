...
$repo = "packet-sys-arena-core"
$language = "R"
$category = "Systems programming"

foreach ($path in @("metadata/domain-review.json", "config/review-profile.json", "fixtures/domain_review.csv", "docs/field-notes.md", "docs/review-journal.md", "examples/packet-sys-arena-walkthrough.md")) {
